...
class Admin_View_Helper_Tree2ul extends Zwe_View_Helper_Tree2ul
{
    ...
    {
        return '<a href="' . $this->view->url(array('module' => 'admin', 'controller' => 'resource', 'action' => 'delete'), 'default') . '">' . $this->view->img('/images/icons/delete_red_16x16.png', array('alt' => 'delete', 'title' => 'Delete')) . '</a>';
    }
}